...
def run_style_transfer(content_img_name, style_img_name, height=400):
    BASE_DIR = os.path.dirname(os.path.abspath(__file__))

    default_resource_dir = os.path.join(BASE_DIR, 'data')
    ...
    result_folder = neural_style_transfer(optimization_config)

    output_file_name = generate_out_img_name(optimization_config)
